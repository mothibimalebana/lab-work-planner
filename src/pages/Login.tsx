    ...
    return(
        <div className="login-container bg-[background: linear-gradient(135deg,#F8FAFC_0%,#FFF_50%,#F0FDFA_100%),#FFF] w-full h-full flex justify-center items-center">
            <div className="login h-full flex flex-col justify-center w-md font-[Arimo] text-[#0A0A0A]">
                <div className="exit flex gap-0.5"><Link className="flex gap-1.5 text-[#0A0A0A]! font-[Arimo] text-md font-normal!" to="/"><img src={back} alt="" /> <p>Back</p></Link></div>
                <form className="flex p-6 rounded-lg border border-solid border-[rgba(0,0,0,0.10)] mt-5 flex-col" action={onSubmit} method="post">
