function Registration(){
    ...
    return(
        <div className="registration px-[5.12rem]">
            <div className="form bg-white p-5 rounded-[0.73163rem]! border border-solid border-[rgba(0,0,0,0.10)]!">
                <form action="# flex flex-col">
                    <div className="head mb-5">
                        <h6>Lab Assistant Availability Form</h6>
                        <p>Select your enrolled modules and mark any additional times you're unavailable</p>
                    </div>
                    ...
                    <div className="availability mb-5">
                        ...
                        <div className="table w-fit mt-2.5">
