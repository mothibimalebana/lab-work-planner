        ...
        <div className="table px-[5.12rem] w-full mt-2.5">
            <table className="w-full rounded-md border border-solid border-[#E5E8EB] bg-white">
                <tbody>
                        ...
                        <td className="w-fit bg-[rgba(236,236,240,0.30)] text-left font-normal">{mode === "Shifts" ? ( role == "assistant" ? <p>14:00 <br />17:00</p> : <p>16:00 <br />20:00</p> ) :  <p>11:10 <br />12:50</p>}</td>
                            {
                                mode === "Shifts"
                                    ?
                                    Array.from(schedule.get("14h00-17h00")?.entries() || []).map(([time, slot]) => (
                                        <td key={time} className={slot.Shift.assistants.length > 0 ? "mx-auto" : ""}>
                                            <div className={slot.Shift.assistants.length > 0 ? "working h-full flex rounded-lg border border-solid border-[#337E89] bg-[rgba(142,184,190,0.20)]" : "freeSlot h-[80%] text-left text-[#99A1AF] rounded-lg border border-solid border-[#E5E8EB] cell p-[0.65rem] text-[0.74513rem]"}>
                                                {slot.Shift.assistants.length > 0 
                                                ? 
                    ...
                    {
                        <tr className="rounded-lg font-[Arimo] border-b border-b-solid border-b-[#E5E8EB]">
                            <td className="w-fit bg-[rgba(236,236,240,0.30)] text-left font-normal">{mode === "Shifts" ? (<p>17:00 <br />20:00</p> ) :  <p>13:00 <br />14:40</p>}</td>
                                {
                                    mode === "Shifts"
                                        ?
                                        Array.from(schedule.get("17h00-20h00")?.entries() || []).map(([time, slot]) => (
                                            <td key={time} className={slot.Shift.assistants.length > 0 ? "mx-auto" : ""}>
                                                <div className={slot.Shift.assistants.length > 0 ? "working h-full flex rounded-lg border border-solid border-[#337E89] bg-[rgba(142,184,190,0.20)]" : "freeSlot h-[80%] text-left text-[#99A1AF] rounded-lg border border-solid border-[#E5E8EB] cell p-[0.65rem] text-[0.74513rem]"}>
                                                    {slot.Shift.assistants.length > 0 
                                                    ? 
                    ...
                    }
                    {
                        ...
                        &&
                        <tr className="rounded-lg font-[Arimo] border-b border-b-solid border-b-[#E5E8EB]">
                            <td className="w-fit bg-[rgba(236,236,240,0.30)] text-left font-normal">{mode === "Shifts" ? ( <p>20:00 <br />00:00</p> ) :  <p>16:40 <br />18:20</p>}</td>
                                {

                                        Array.from(schedule.get("20h00-00h00")?.entries() || []).map(([time, slot]) => (
                                            <td key={time} className={slot.Shift.assistants.length > 0 ? "mx-auto" : ""}>
                                                <div className={slot.Shift.assistants.length > 0 ? "working h-full flex rounded-lg border border-solid border-[#337E89] bg-[rgba(142,184,190,0.20)]" : "freeSlot h-[80%] text-left text-[#99A1AF] rounded-lg border border-solid border-[#E5E8EB] cell p-[0.65rem] text-[0.74513rem]"}>
                                                    {slot.Shift.assistants.length > 0 
                                                    ? 
