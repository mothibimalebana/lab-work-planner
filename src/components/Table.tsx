        ...
        <div className="table px-[5.12rem] w-full mt-2.5">
            <table className="w-full rounded-md border border-solid border-[#E5E8EB] bg-white">
                <tbody>
                    ...
                    <tr className="rounded-lg font-[Arimo] border-b border-b-solid border-b-[#E5E8EB]">
                        <td className="w-fit bg-[rgba(236,236,240,0.30)]  text-left font-normal">{mode === "Shifts" ? (role === "assistant" ? <p>11:00 <br />14:00</p> : <p>12:00 <br />16:00</p> ) :  <p>07:30 <br />09:10</p>}</td>
                        {
                    ...
                    <tr className="rounded-lg font-[Arimo] border-b border-b-solid border-b-[#E5E8EB]">
                        <td className="w-fit bg-[rgba(236,236,240,0.30)]  text-left font-normal">{mode === "Shifts" ? (role === "assistant" ? <p>14:00 <br />17:00</p> : <p>16:00 <br />20:00</p> ) :  <p>07:30 <br />09:10</p>}</td>
                        {
                    ...
                    <tr className="rounded-lg font-[Arimo] border-b border-b-solid border-b-[#E5E8EB]">
                        <td className="w-fit bg-[rgba(236,236,240,0.30)]  text-left font-normal">{mode === "Shifts" ? (role === "assistant" ? <p>20:00 <br />20:00</p> : <p>00:00 <br />12:00</p> ) :  <p>07:30 <br />09:10</p>}</td>
                        {
                    ...
                    <tr className="rounded-lg font-[Arimo] border-b border-b-solid border-b-[#E5E8EB]">
                        <td className="w-fit bg-[rgba(236,236,240,0.30)]  text-left font-normal">{mode === "Shifts" ? (role === "assistant" ? <p>20:00 <br />00:00</p> : "") :  <p>07:30 <br />09:10</p>}</td>
                        {
