        ...
        <div className="table px-[5.12rem] w-full mt-2.5">
            <table className="w-full rounded-md border border-solid border-[#E5E8EB] bg-white">
                <tbody>
                    ...
                    <th className="w-[2.13rem] bg-[rgba(236,236,240,0.30)]  text-left font-normal">Time</th>
                    ...
                    <tr className="rounded-lg border-b border-b-solid border-b-[#E5E8EB]">
                        ...
                        {schedule[3].map((shift) => shift.shift ? <td><div className="cell p-[0.65rem] text-[0.74513rem]"> <h6>Lab Assistant</h6> <p>{shift.supervisor}</p> <p>{shift.lab}</p> </div></td> : <td><div className="freeSlot h-[80%] text-left text-[#99A1AF] rounded-lg border border-solid border-[#E5E8EB] cell p-[0.65rem] text-[0.74513rem]">Free slot</div></td>)}
                    </tr>
                    <tr className="rounded-lg border-b border-b-solid border-b-[#E5E8EB]">
